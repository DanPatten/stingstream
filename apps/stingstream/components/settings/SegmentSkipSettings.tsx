...
/**
 * What to do when a player reaches an intro, an outro, a recap, an advert or a
 * next-episode preview.
 *
 * A page of its own until Playback & subtitles gathered the four playback pages
 * into one; it is a block inside that page's first section now. Nothing about
 * the controls changed.
 */
export const SegmentSkipSettings: React.FC = () => {
