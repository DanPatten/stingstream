 ...
 * `constants/brand/paths.ts`, the committed, app-importable copy of the same data that
...
async function main() {
  ...
  // ---- constants/brand/paths.ts: the app-importable copy of the data above -
  ...
  writeFileSync(
    outPath("constants", "brand", "paths.ts"),
    constantsContent,
    "utf8",
  );
  console.log("wrote constants/brand/paths.ts");
