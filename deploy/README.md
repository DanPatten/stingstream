...
Everything needed to run a StingStream node outside a development checkout: Dockerfiles, Docker
Compose files, and platform installers. See `docs/RELEASING.md` for how it all gets built and
published.
